...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-04-2017 a las 02:47:48
...
INSERT INTO `cel` (`id`, `idEmpl`, `cel`) VALUES
(1, 1, '96050720'),
(2, 2, '32454545'),
(3, 3, '96050772');
...
INSERT INTO `correo` (`id`, `idEmpl`, `correo`) VALUES
(1, 1, 'cflores info'),
(2, 1, 'supervisor_soporte com');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `correoe`
--
...
--
-- Volcado de datos para la tabla `correoe`
--

INSERT INTO `correoe` (`id`, `idEmpl`, `correo`) VALUES
(1, 1, 'Supervisor_soporte'),
(2, 2, 'correo'),
(3, 3, 'externo');
...
--
-- Estructura de tabla para la tabla `correoi`
--

CREATE TABLE `correoi` (
  `id` int(8) NOT NULL,
  `idEmpl` int(8) NOT NULL,
  `correo` varchar(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Volcado de datos para la tabla `correoi`
--

INSERT INTO `correoi` (`id`, `idEmpl`, `correo`) VALUES
(1, 1, 'cflores'),
(2, 2, 'Plaza'),
(3, 3, 'Honduras');
...
CREATE TABLE `empleados` (
  ...
  `marcaje` varchar(20) NOT NULL,
  `Estado` int(8) NOT NULL,
  `iddep` int(8) NOT NULL,
  `idtiend` int(8) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `empleados` (`id`, `nombre`, `marcaje`, `Estado`, `iddep`, `idtiend`) VALUES
(1, 'Carlos Flores', '37051', 1, 1, 1),
(2, 'Nombre Prueba', '57034', 1, 2, 2),
(3, 'san jack', '001810', 1, 3, 3);
...
--
-- Volcado de datos para la tabla `tel`
--

INSERT INTO `tel` (`id`, `tel`, `idEmpl`) VALUES
(1, '1134', 1),
(2, '1122', 2),
(3, '1135', 3);
...
INSERT INTO `tienda` (`id`, `nombre`, `tienda`) VALUES
(1, 'Femosa AV Junior', 'FMSPS01'),
(2, 'Femosa Multiplaza', 'FMSPS02'),
(3, 'Femosa Galerias', 'FMSPS03'),
(4, 'Femosa Progreso', 'FMPRO01'),
(5, 'Femosa LCB', 'FMLCE01'),
(6, 'SJ Multiplaza', 'SJSPS01'),
(7, 'SJ Galerias', 'SJSPS02'),
(8, 'SJ Progreso', 'SJPRO01'),
(9, 'SJ La Ceiba', 'SJLCB01'),
(10, 'SJ Toncontin Tegus', 'SJTGU02'),
(11, 'SJ Multiplaza Tegus', 'SJTGU01'),
(12, 'SJ El doraro Tegus', 'SJTGU03');
...
(1, 1, 'admin', 'Carlos Dario Flores NuÃ±ez', 'scdfn3@hotmail.com', '4597015834', '90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad', 'En pruebna', '#'),
(5, 1, 'admin2', 'admin', 'cdfn33@gmail.com', '3434', '90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad', '1', '');
...
INSERT INTO `usuarios2` (`id`, `Nombre`, `Contra`, `idEmpleado`, `Estado`) VALUES
(11, 'admin', 'admin', 1, '1');
...
--
-- Indices de la tabla `correoe`
--
ALTER TABLE `correoe`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `correoi`
--
ALTER TABLE `correoi`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `correoe`
--
ALTER TABLE `correoe`
  MODIFY `id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `correoi`
--
ALTER TABLE `correoi`
  MODIFY `id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
